  ...
  return (
    ...
    <main className="flex h-screen flex-col items-center bg-black">
      {(isRecording || transcript || response) && (
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-full m-auto p-4  bg-white text-black">
          <div className="flex justify-center items-center w-full">
            <div className="text-center">
              <p className="text-xl font-bold text-black">{isRecording ? "Listening" : ""}</p>
              {transcript && (
                <div className="p-2 h-full mt-4 text-center">
                  <p className="text-lg text-black mb-0">{transcript}</p>
                </div>
              )}
            </div>
          </div>
